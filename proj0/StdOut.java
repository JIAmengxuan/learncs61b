...
import java.util.Locale;
   ...
   iStandard outputi. This class provides methods for writing strings
   and numbers to standard output.
   p
   For additional documentation, see a href=httpintrocs.cs.princeton.edu15inoutSection 1.5a of
   iIntroduction to Programming in Java An Interdisciplinary Approachi by Robert Sedgewick and Kevin Wayne.
